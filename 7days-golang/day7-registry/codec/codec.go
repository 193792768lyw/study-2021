...
type Header struct {
	ServiceMethod string // format "Service.Method"  是服务名和方法名，通常与 Go 语言中的结构体和方法相映射。
	Seq           uint64 // sequence number chosen by client 是请求的序号，也可以认为是某个请求的 ID，用来区分不同的请求。
...
const ( // 定义了 2 种 Codec，Gob 和 Json
